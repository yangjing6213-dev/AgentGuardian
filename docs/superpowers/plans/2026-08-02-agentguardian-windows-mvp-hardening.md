...
| 5 | Packaging and release provenance | Portable development layer locally verified at `d310608b4c7f19f19a6089a1d0c15d6560391fa2`: reproducible PyInstaller `onedir`, SBOM with the embedded bootloader as a runtime dependency, manifests, checksums, deterministic ZIP, and isolated launch/cleanup smoke. Trusted signing, native installation, clean-machine acceptance, and uninstall-residue evidence remain pending. |
