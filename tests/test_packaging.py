    ...
    probe = subprocess.run(
        [
            ...
            (
                ...
                "assert static_capability_findings()==('NETWORK_MODULE_IMPORT','SHELL_EXECUTION','USER_DATA_WRITE');"
                "assert audit['findings']==['NETWORK_MODULE_IMPORT','SHELL_EXECUTION','USER_DATA_WRITE'] and not audit['local_only'];"
