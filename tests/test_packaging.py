    ...
    probe = subprocess.run(
        [
            ...
            (
                ...
                "assert static_capability_findings()==('NATIVE_CAPABILITY','NETWORK_MODULE_IMPORT','SHELL_EXECUTION','USER_DATA_WRITE');"
                "assert audit['findings']==['NATIVE_CAPABILITY','NETWORK_MODULE_IMPORT','SHELL_EXECUTION','USER_DATA_WRITE'] and not audit['local_only'];"
