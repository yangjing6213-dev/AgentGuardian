...
def test_real_detection_scoring_reporting_chain_keeps_raw_data_private() -> None:
    ...
    json_report = render_json(audit_score, findings, rule_version="rules-1")
    html_report = render_html(audit_score, findings, rule_version="rules-1")
    finding = findings[0]
...
def test_scoring_and_reporting_use_only_approved_imports_and_calls() -> None:
    ...
    allowed_attribute_calls = {
        ...
        "reporting.py": {"append", "dumps", "extend", "join", "lower"},
    }
