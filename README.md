...
- The native Windows MCP path rechecks the adapter SHA-256, requires a locally trusted embedded Authenticode signature, and requires an explicit exact-match X.500 publisher-subject allowlist before launch. Empty or non-matching allowlists are denied. An organization-signed adapter artifact and clean-machine acceptance remain release gates.
- Latest exact-SHA revalidation for repository HEAD `e5c279abab984a801c066ff459f6f1387fe40758`: local `1436 passed, 11 skipped`; selected Windows MVP security gate `47 passed, 1 skipped`; push CI `31890969434`, push Windows `31890969501`, Draft PR CI `31890971629`, and Draft PR Windows `31890971646` all completed successfully. This confirms the submitted code path and Windows CI smoke only; trusted signing, clean-machine acceptance, manual sanitized-sample signoff, and production safety remain open.
