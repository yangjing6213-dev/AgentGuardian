...
- Latest exact-SHA revalidation for `ef571a1c2df6de806f5cb488979778bec6c5bd9f`: local `1426 passed, 11 skipped`; push CI `31887042189`, push Windows `31887042244`, Draft PR CI `31887043260`, and Draft PR Windows `31887043232` all completed successfully. This confirms the submitted code path and Windows CI smoke only; trusted signing, clean-machine acceptance, real sanitized samples, and production safety remain open.
