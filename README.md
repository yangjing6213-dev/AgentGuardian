...
- Latest verification for code SHA `5fcb252c1874c949e97a99eba0ea08eb634eb0b8`: local `1392 passed, 11 skipped`; push CI, push Windows, Draft PR CI and Draft PR Windows all succeeded (`31877751306`, `31877751258`, `31877752695`, `31877752689`). GitHub Windows full suite reported `1402 passed, 1 skipped`; the synthetic high-sensitivity gate reported `passed=true`, no raw marker in JSON/HTML/export/findings, browser temporary copy removed, and workspace cleanup true. The MSIX evidence recorded install, same-identity upgrade `0.1.0.0 -> 0.1.0.1`, termination, uninstall, and `package_residue=false`; signature mode remains `unsigned_ci_smoke`.
