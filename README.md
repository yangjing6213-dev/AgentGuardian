...
- The release gate retains bundle path safety, exact source SHA, trusted package signature evidence when requested, fresh-user-state evidence, SBOM/notices/checksums, and license review. MSIX verification retains install, launch, same-identity upgrade, process termination, uninstall, app-data residue checks, and sanitized evidence.
