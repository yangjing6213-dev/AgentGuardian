...
- Latest exact-SHA revalidation for `bd4f5cc4a2957e222beacd7b7b24c8fbd98e7ddb`: local `1424 passed, 11 skipped`; push CI, push Windows, Draft PR CI, and Draft PR Windows all completed successfully. This confirms the submitted code path and Windows CI smoke only; trusted signing, clean-machine acceptance, real sanitized samples, and production safety remain open.
